...
if __name__ == "__main__":
    folder = "/home/azureuser/liangyu/mscclpp-public/blink_msccl_xml"
    assert os.path.exists(folder)
    assert os.path.exists(os.path.join(folder, "blink_results"))
...
/home/azureuser/liangyu/nccl-tests/build/all_gather_perf -b 256 -e 10G -f 2 -g 1 -z 0 -n 100 -w 100 -c 0 -a 2"""
            ...
            res_file = os.path.join(folder, "blink_results", fname + f"buff{buff_size}.txt")
